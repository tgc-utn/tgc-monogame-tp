...
namespace TGC.MonoGame.TP.SkyboxSimple
{
    /// <summary>
    ...
    public class SkyBox2
    {
        ...
        public SkyBox2(Model model, TextureCube texture, Effect effect) : this(model, texture, effect, 50)
        {
        }
        ...
        public SkyBox2(Model model, TextureCube texture, Effect effect, float size)
        {
            Model = model;
            Texture = texture;
            Effect = effect;
