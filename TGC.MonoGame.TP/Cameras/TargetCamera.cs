...
namespace ThunderingTanks.Cameras
{
    ...
    public class TargetCamera : Camera
    {
        ...
        private const float InitialCameraFollowRadius = 1300f;
        ...
        public void BuildView()
        {
            ...
            View = Matrix.CreateLookAt(Position, FrontDirection + Position, UpDirection);
        }
        ...
        public void Update(Vector3 targetPosition, float yaw)
        {
            ...
            var orbitalPosition = _cameraFollowRadius * playerBackDirection;
