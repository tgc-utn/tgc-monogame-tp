...
public class CustomPipelineManager : PipelineManager
{
    ...
    public void BuildAnimationContent(string modelFilename)
    {
        ...
        var nodeContent =
            importer.Import(ProjectDirectory + modelFilename + ".fbx", importContext);
        ...
        var pipelineEvent = new PipelineBuildEvent
        {
            ...
            DestFile = OutputDirectory + modelFilename + ".xnb",
            Importer = ".fbx",
            Processor = "Animation Processor",
            Parameters = ValidateProcessorParameters("Animation Processor", parameters)
        };
