...
namespace TGC.MonoGame.TP.Skydome
{
    /// <summary>
    ...
    public class SkyDome
    {
        ...
        public SkyDome(Model model, Texture2D texture, Effect effect) : this(model, texture, effect, 50)
        {
        }
        ...
        public SkyDome(Model model, Texture2D texture, Effect effect, float size)
        {
            Model = model;
            Texture = texture;
            Effect = effect;
            ...
            foreach (var pass in Effect.CurrentTechnique.Passes)
            {
                ...
                foreach (var mesh in Model.Meshes)
                {
                    ...
                    foreach (var part in mesh.MeshParts)
                    {
                        ...
                        part.Effect.Parameters["SkyDomeTexture"].SetValue(Texture);
