...
namespace MonoGamers.Camera;
    ...
    /// </summary>
    public class TargetLightCamera : Camera
     {
        /// <summary>
        ...
        public TargetLightCamera(float aspectRatio, Vector3 position, Vector3 targetPosition) : base(aspectRatio)
        {
        ...
        public TargetLightCamera(float aspectRatio, Vector3 position, Vector3 targetPosition, float nearPlaneDistance,
