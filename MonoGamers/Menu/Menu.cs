...
public class Menu
{
    ...
    public void LoadContent()
    {
        ...
        PlayButton = new Button(_contentManager.Load<Texture2D>(ConfigurationManager.AppSettings["ContentFolderTextures"] + "menu/play"), new Vector2(width * 0.410f, height * 0.35f), 1.1f);
        ExitButton = new Button(_contentManager.Load<Texture2D>(ConfigurationManager.AppSettings["ContentFolderTextures"] + "menu/exit"), new Vector2(width * 0.425f, height * 0.55f), 1f);
    ...
    public void Draw(SpriteBatch spriteBatch)
    {
        var width = _graphicsDevice.Viewport.Width;
        var height = _graphicsDevice.Viewport.Height;
        spriteBatch.Draw(Title, new Rectangle((int)(width * 0.350f), (int)(height * 0.10f), Title.Width, Title.Height), Color.White);
